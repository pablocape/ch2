...
//MULTIJADOR --> ESTE ES TABLERO INVERTIDO (LAS BLANCAS BAJAN, LAS NEGRAS SUBEN)
// LAS BLANCAS SON LAS NEGRAS Y VICEVERSA, CON POSICION DAMA Y REY CAMBIADAS
// TAMBIEN CAMBIA ENROQUE LARGO Y CORTO

// ES ASI PORQUE LAS BLANCAS (O NEG INV) DEBEN SUBIR Y LAS NEGRAS (O BLANCAS INV) DEBEN BAJAR PARA NO MODIFICAR LAS FUNCIONES
...
function send_move(pieza,html_pieza)
{
	...
	if(pieza)
		parent.postMessage([black_coord[mov_yx[0]],black_coord[mov_yx[1]],pieza,html_pieza], 'http://www.pampachess.com/');
	else
		parent.postMessage([black_coord[mov_yx[0]],black_coord[mov_yx[1]]], 'http://www.pampachess.com/');
}
...
function receiveMessage(event)
{
  ...
  //if (origin !== "http://localhost:8080/")
	...
	var pos1 = black_rev[event.data[0]];
	pos2 = black_rev[event.data[1]];

	
	console.log('player2: receive move');
...
var mov_ataque_blancas = {a:[[5,1]], b:[[5,0],[5,2]], c:[[5,1],[5,3]], d:[[5,2],[5,4]], e:[[5,3],[5,5]], f:[[5,4],[5,6]], g:[[5,5],[5,7]], h:[[5,6]], 4:[[5,0],[5,2],[6,3]], 7:[[5,5],[5,7],[6,4]], 1:[[6,2],[6,3],[6,4],[7,2],[7,4]]};
var mov_ataque_negras = {a:[[2,1]], b:[[2,0],[2,2]], c:[[2,1],[2,3]], d:[[2,2],[2,4]], e:[[2,3],[2,5]], f:[[2,4],[2,6]], g:[[2,5],[2,7]], h:[[2,6]], 4:[[2,0],[2,2],[1,3]], 7:[[2,5],[2,7],[1,4]], 1:[[0,2],[0,4],[1,2],[1,3],[1,4]]};
var pos_piezas_blancas = {1:[7,3], 2:[7,4], 3:[7,2], 4:[7,1], 5:[7,0], 6:[7,5], 7:[7,6], 8:[7,7], a:[6,0], b:[6,1], c:[6,2], d:[6,3], e:[6,4], f:[6,5], g:[6,6], h:[6,7]};
var pos_piezas_negras = {1:[0,3], 2:[0,4], 3:[0,2], 4:[0,1], 5:[0,0], 6:[0,5], 7:[0,6], 8:[0,7], a:[1,0], b:[1,1], c:[1,2], d:[1,3], e:[1,4], f:[1,5], g:[1,6], h:[1,7]};
